...
//		}
//		
//		testGraph.implementAddEdge(0, 1);
//		testGraph.implementAddEdge(1, 2);
//		testGraph.implementAddEdge(2, 3);
//		testGraph.implementAddEdge(2, 4);
//		
//		for (int i=0;i<5;i++) {
//			int size = testGraph.getNeighbors(i).size();
//			degreeSeq.add(size);
//		}
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", testGraph);
...
//		System.out.println("Goal: implement method using two approaches.");
		...
		GraphAdjList testRun = new GraphAdjList();
		testRun.degreeSequence();
